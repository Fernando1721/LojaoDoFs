...
import { ip, ipspring } from "../../../config/ip";
...
obterId();
  ...
  useEffect(() => {
    fetch(`${ip}/api/usuarios/carrinho/${obterId()}`)
        ...
        <View>
          <ScrollView horizontal={false}>
            {produtos.map((itens, ix) => (
              <View key={ix} style={{ flex: 1, justifyContent: "center", padding:10, borderBottomWidth:2, borderColor:"silver",
              flexDirection:"row" }}>
                ...
                <View style={{flexDirection: "column", flex:1, alignItems:"center", justifyContent:"center", paddingBottom:30}}>
